define(["utils", "base"], function(utils, baseClass) {
	...
	Component.prototype.startSort = function() {
		...
		this.isInSort = true;
		var targetStartPos = null,
			touchStartX, touchStartY, diffX, diffY, cloneItem;
	...
	Component.prototype._itemClick = function(itemInstance) {
		...
		if(this.pageview.plugin) {
			...
			method && method.call(this.pageview.plugin, itemInstance, {
				index: itemInstance.$el.index()
			});
		}
